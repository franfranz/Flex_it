...
#  Please make sure you have the morph-it list and the noun_lemma list before proceeding. 
#  The noun_lemma list of word frequencies is available here (https://github.com/franfranz/Flex_it/tree/main/code)
...
for (everyclass in infclasstypes$class){
  ...
  classfreqs= c(infclasstypes$femm[class_ord], infclasstypes$masc[class_ord])
...
infclasstokens= aggregate(x=all_nouns_lemmas_dp_inf$Freq, by=list(all_nouns_lemmas_dp_inf$class, all_nouns_lemmas_dp_inf$Gender), FUN=sum)
infclasstokens_sum= aggregate(x=all_nouns_lemmas_dp_inf$Freq, by=list(all_nouns_lemmas_dp_inf$class), FUN=sum)

infclasstokens_f= infclasstokens[infclasstokens$Group.2=="femm", ]
infclasstokens_f$Group.2=NULL
colnames(infclasstokens_f)=list("class", "femm_token")


infclasstokens_m= infclasstokens[infclasstokens$Group.2=="masc", ]
infclasstokens_m$Group.2=NULL
colnames(infclasstokens_m)=list("class", "masc_token")

infclasstokens_tot=merge(infclasstokens_f, infclasstokens_m, by.x = "class", by.y = "class", all.x = T, all.y = T)
infclasstokens_tot[is.na(infclasstokens_tot)] = 0
infclasstokens_tot$tot_tokens=rowSums(infclasstokens_tot[c(2:3)])  
...
for (everytokclass in infclasstokens_tot$class){
  ...
  classfreqs_tok= c(infclasstokens_tot$femm_token[class_ord_tok], infclasstokens_tot$masc_token[class_ord_tok])
